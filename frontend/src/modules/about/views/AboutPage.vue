<template>
	<div class="about-page">
		<div class="about-block">
			<h1>关于本站 ——「{{ appTitle }}」</h1>
			<p>
				在刚接触计算机的时候，很多知识都是从网上博客学到的，那些极具个性的博客给予我很深的印象，点击就会迸发彩带的光标、桌宠、飘落着的会随光标组装的几何线条......当时就想着等自己学成了也要做个人博客。
			</p>
			<p>于是乎「青禾边」就这样诞生了。</p>
			<p>
				虽然以前浏览的大多是技术博客，但是我对「青禾边」的定位不止于此，我希望它能成为一个小窝，不仅仅是分享技术（详情请参考分类），也记录我的兴趣爱好和生活。
			</p>
			<p>
				虽然在 2026
				年中就已经筹划着买下了域名等等，但是由于学业、技术不够成熟、<del>偷懒</del>等不可抗拒因素（bushi），该站直到
				x 年 x 月才正式上线。前期为了夯实基础，基本都是手写代码，后期赶上 AI
				大爆发，于是开始尝试使用 codex 等工具编写代码。
			</p>
			<p>本站技术栈：</p>
			<ul>
		...
		<div class="about-block">
			...
			<p>一名普通的在读的大三生。</p>
			<p>
				目前正为了就业还是读研而纠结中，纠结后的结论是不管三七二十一先学东西，能学多少是多少（）
			</p>
			<p>
