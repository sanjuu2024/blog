...
| ------ | -------- | ------------ | ------------------------------------------------------------ | ---------------- | ---------------- |
| P1-001 | Minor    | 后台用户管理 | 发现版本 `6c58e507a7a8f68e586828e630413dd7bda2de2e` 存在问题：<br />用户名和邮箱筛选使用大小写敏感匹配，与登录、查重及文档规则不一致。<br />输入 HEFA 无法匹配已注册用户名 hefa。 | 处理结果：待修复 | 复测结果：待复测 |
