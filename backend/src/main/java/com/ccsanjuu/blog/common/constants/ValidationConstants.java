...
public final class ValidationConstants {
    private static final String USERNAME_BODY_PATTERN = "[A-Za-z0-9_-]+";
    private static final String ACCOUNT_USERNAME_BODY_PATTERN = "[A-Za-z0-9_-]{2,20}";
    ...
    public static final String USERNAME_MESSAGE = "用户名只能包含英文字母、数字、下划线或短横线";
