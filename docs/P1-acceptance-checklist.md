...
| 项目                  | 记录                                                         |
| --------------------- | ------------------------------------------------------------ |
| 验收版本 / Commit SHA | 064f36065f1986c609cb0de64b6fb142aa8b4ac2                     |
| 验收分支              | `develop`                                                    |
| 验收开始时间          | 2026-09-16                                                   |
| 验收完成时间          |                                                              |
| 验收负责人            | sanjuu                                                       |
...
| 操作系统 / 设备       | Windows 11                                                   |
| 关联 CI 运行地址      | [CI #19](https://github.com/sanjuu2024/blog/actions/runs/35301412862) |
| 最终结论              | 进行中                                                       |
...
| P1-003 | Minor | 后台分类管理 | 发现版本 `064f36065f1986c609cb0de64b6fb142aa8b4ac2` 存在问题：<br />后台分类管理筛选条件为 `禁用` 时，仅筛选出了禁用的一级分类，未显示被单独禁用的二级分类。 | 处理结果：已改为任一筛选条件返回平铺列表。 | 复测结果：已复测。 |
